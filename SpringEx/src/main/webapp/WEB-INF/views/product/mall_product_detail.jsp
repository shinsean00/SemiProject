...
<body>
	...
	<div class="content">
		...
		<div class="breadcrumb">
			<a href="${contextPath}/product/mall_product_list.do">상품</a> > <a href="${contextPath}/product/mall_product_list.do">상품리스트</a> > <a class="current">상품 상세</a>
		</div>
		...
		<div class="prd_detail">
			<div class="prdimage">
				<div class="bigImages">
					<img id="big"
						src="${contextPath}/resources/images/product/${product[0].product_no}_thumbnail_01.jpg"
						alt="썸네일 이미지1">
				</div>
			...
			<div class="prd_order">
				<div class="prd_info">
					<h3>상품 번호 : ${product[0].product_no}</h3>
				...
				<ul>
					<li><label>주문자와 동일  </label><input type="checkbox" id="order_cb" onclick="loadUserInfo(this)"><label for="order_cb"></label></li>
					<li>수취인명 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><input type="text" id="recipient" class="address" placeholder="이름을 입력하세요"></li>
					<li><form>배송지 정보<br>
						...
						<input type="text" id="address" class="address" placeholder="주소"><br>
						<input type="text" id="detailAddress" class="address" placeholder="상세주소">
						<input type="text" id="extraAddress" class="address" placeholder="참고항목">
					</form></li>
					<li>
					<label>연락처</label> 
					  <select class="phone_num" id="tel_first">
					  ...
					  <input type="text" class="phone_num" id="tel_middle" placeholder="1234">-<input type="text" class="phone_num" id="tel_last" placeholder="1234"><br>
					</li>
				</ul>
				</div>
				<div class="order_section">
				  <span id="order_total">주문 금액 : <fmt:formatNumber value="${product[0].product_price}" pattern="###,###원"/></span>
 				  <button class="order_btn btnPush" onclick="sendOrder()">주문하기</button>
				</div>
		</div>
	</div>
		<div class="img-detail">
			<img src="${contextPath}/resources/images/product/${product[0].product_no}_detail.jpg">
		</div>
	</div>
